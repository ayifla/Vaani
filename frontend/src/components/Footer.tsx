...
export const Footer: React.FC = () => {
  return (
    <footer className="w-full bg-[#FDFBF7] dark:bg-[#15221C] border-t border-[#E3DAC9] dark:border-[#283D33] py-6 mt-auto transition-colors duration-300">
      <div className="w-full px-4 sm:px-6 lg:px-8 max-w-7xl mx-auto flex flex-col md:flex-row items-center justify-between gap-4 text-xs text-[#72786F] dark:text-[#9BB0A4]">
        ...
        <div className="flex items-center gap-4 flex-wrap justify-center">
          <span className="text-[#9DA39A] dark:text-[#6B7A70]">Accessible Communication Framework</span>
          <span className="text-[#E3DAC9] dark:text-[#283D33]">•</span>
          <span className="text-[#1E3A2B] dark:text-[#EDE8E1] font-semibold">Signs that Speak</span>
          <span className="text-[#E3DAC9] dark:text-[#283D33]">•</span>
          <span className="text-[#9DA39A] dark:text-[#6B7A70]">© 2025 Vaani. Voice of Hands.</span>
        </div>
